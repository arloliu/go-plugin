...
const file_internal_plugin_grpc_controller_proto_rawDesc = "" +
	"\n" +
	"%internal/plugin/grpc_controller.proto\x12\x06plugin\"\a\n" +
	"\x05Empty2:\n" +
	"\x0eGRPCController\x12(\n" +
	"\bShutdown\x12\r.plugin.Empty\x1a\r.plugin.EmptyB.Z,github.com/arloliu/go-plugin/internal/pluginb\x06proto3"

var (
	file_internal_plugin_grpc_controller_proto_rawDescOnce sync.Once
	file_internal_plugin_grpc_controller_proto_rawDescData []byte
)
...
func file_internal_plugin_grpc_controller_proto_rawDescGZIP() []byte {
	file_internal_plugin_grpc_controller_proto_rawDescOnce.Do(func() {
		file_internal_plugin_grpc_controller_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_plugin_grpc_controller_proto_rawDesc), len(file_internal_plugin_grpc_controller_proto_rawDesc)))
	})
...
var file_internal_plugin_grpc_controller_proto_goTypes = []any{
...
func file_internal_plugin_grpc_controller_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_plugin_grpc_controller_proto_rawDesc), len(file_internal_plugin_grpc_controller_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
