...
[README](https://github.com/arloliu/go-plugin/blob/master/README.md).

## Table of Contents

**[Writing Plugins Without Go](https://github.com/arloliu/go-plugin/blob/master/docs/guide-plugin-write-non-go.md).**
This shows how to write a plugin using a programming language other than
Go.

**[Extensive Tutorial on Usage](https://github.com/arloliu/go-plugin/blob/master/docs/extensive-go-plugin-tutorial.md).**
